...
function FactorPortfolio() {
    ...
    const [factorsBool, setfactorsBool] = useState([false, true, false, false, false, false, false])
    console.log(factorsBool);
    const [factors, setfactors] = useState(["Momentum", "Liquidity", "Size", "Value", "Volatilty", "Quality", "Growth"])
    ...
    const indexOfFactor = (x) => {
        return x == "Momentum" ? 0 : x == "Liquidity" ? 1 : x == "Size" ? 2 : x == "Value" ? 3 : x == "Volatilty" ? 4 : x == "Quality" ? 5 : x == "Growth" ? 6 : -1;
    }
    return (
        <div className={styles.outermost}>
            {showModal && <div className={styles.modal}>
                <div className={styles.modalinner}>
                    <h4 className={styles.modalstepsheader}>4 easy steps to calculate your portfolio
                    </h4>
                ...
                <div className={styles.closemodalbtn} onClick={() => setShowModal(false)}>
                    <RiCloseLine style={{ transform: "scale(2)" }} />
                </div>
            </div>}
            <div className={styles.outer} style={showModal ? { filter: "blur(1.5px)" } : null}>
                ...
                <h4 className={styles.stepsheader}>4 easy steps to calculate your portfolio
                    <section className={styles.info} onClick={() => { setShowModal(true) }}>i</section>
                </h4>
                <div className={styles.steps}>
                    <div className={styles.step}>
                        ...
                        <div className={styles.content}>
                            <div className={styles.headrow}>
                                ...
                                <input type="date" id="seldate" name="seldate" className={styles.datepicker} />
                                {/* <DatePicker
                        ...
                        <div className={styles.content}>
                            <div className={styles.headrow}>
                                ...
                                {indices.map((x, id) => {
                                    return (
                                        <>
                                            <input type="radio" name="index" id={id} style={{ display: "none" }} />
                                            <label for={id} className={styles.index}
                                                style={activeIndex == id ? { background: "#D9DDFF" } : null}
                                        ...
                                        return (
                                            <>
                                                <div className={styles.factor}>
                                                    <input className={styles.factorinput} type="checkbox"
                                                        name="momentum" id={id + "factor"} checked={factorsBool[id]}
                                                        onClick={() => {
                                                            const arr = []
                                                            factors.map((y, id2) => {
                                                                id2 == id ? arr.push(!factorsBool[id2]) : arr.push(factorsBool[id2])
                                                            })
                                                            setfactorsBool(arr)
                                                        }}
                                                    />
                                                ...
                                                {id == 4 && <div className={styles.selectallbtn} onClick={selectAll}>Select All</div>}
                                            </>
                                        )
                                    })
                                    }
                                    ...
                                    <table className={styles.table}>
                                        <thead style={{ display: "block" }}>
                                            <tr className={styles.trhead}>
                                                <th style={{
                                                    minWidth: "0", width: "5vw", paddingLeft: "2vw"
                                                }}>Name</th>
                                                {factorsBool[1] &&
                                                    <th>Liquidity</th>
                                                }
                                        ...
                                        <tbody className={styles.nonhead}>
                                            {table1Indices.map(x => {
                                                return (
                                                    <tr>
                                                        <td style={{
                                                            textAlign: "left", width: "5vw", minWidth: "0",
                                                            paddingLeft: "2vw", background: "inherit"
                                                        }} >
                                                            {data.Name[x]}
                                                        </td>
                                                        {factorsBool[1] &&
                                                            <td>{data.Liquidity[x]}</td>
                                                        }
                                                        {factorsBool[3] &&
                                                            <td>{data.Value[x]}</td>
                                                        }
                                                        {factorsBool[4] &&
                                                            <td>{data.Volatility[x]}</td>
                                                        }
                                                        {factorsBool[5] &&
                                                            <td>{data.Quality[x]}</td>
                                                        }
                                                        <td style={{ paddingRight: "0.5vw" }}>
                                                            <section style={{ marginRight: "2vw" }}>Dummy Av</section>
                                                        </td>
                                                    </tr>
                                                )
                                            })
                    ...
                    <div className={styles.step}>
                        ...
                        <div className={styles.content}>
                            ...
                            <input className={styles.nseip} type="text" placeholder="tcs,infy"></input>
                            <div className={styles.factortable}>
                                {/* <div className={styles.avbtn} onClick={() => { scroll(500) }}>Average</div>
                                <div className={styles.tablediv} ref={ref}> */}
